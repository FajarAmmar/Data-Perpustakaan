...
<tr>
        <td><td>
        <td><input type="Button" name="kembali" value="Kembalikan" class="btn btn-success"></td>
        <td><input type="Button" name="perpanjang" value="Perpanjang" class="btn btn-info"></td>
</tr>
    </table>
  </div>
</div>
