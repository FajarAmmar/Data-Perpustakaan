...
<html lang="en">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    <a class="dropdown-item" href="form_kembali"
                      >Pengembalian</a
                    >
                  </li>
                </ul>
  ...
  <div class="card-body">
    <form action="configuration/update_buku.php" method="POST">
      <table>
        <?php
    ...
    if (isset($_GET['id'])) {
        ...
        <tr><input type="number" class="form-control" name="id_buku" readonly value="<?php echo $bk['id_buku'] ?>"></tr>
        <tr><label for="">Judul Buku</label></tr>
        <tr><input type="text" class="form-control" name="judul_buku" value="<?php echo $bk['judul_buku'] ?>"></tr>
        <tr><label for="">Penulis Buku</label></tr>
        <tr><input type="text" class="form-control" name="penulis_buku" value="<?php echo $bk['penulis_buku'] ?>"></tr>
        <tr><label for="">Penerbit Buku</label></tr>
        <tr><input type="text" class="form-control" name="penerbit_buku" value="<?php echo $bk['penerbit_buku'] ?>"></tr>
        <tr><label for="">Kategori Buku</label></tr>
        <tr><input type="text" class="form-control" name="kategori_buku" value="<?php echo $bk['kategori_buku'] ?>"></tr>
        <tr><label for="">Status Buku</label></tr>
        <tr><input type="text" class="form-control" name="status_buku" readonly value="<?php echo $bk['status_buku'] ?>"  ></tr>
        <?php }
      } ?>
      <br>
        <tr>
